...
export default function SignUpPage(){
    ...
    const validateForm = () => {
        ...
        // Simple email regex pattern (checks for something@something.something)
        const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        if (!emailPattern.test(formData.email.trim())) return toast.error('Please enter a valid email address');
